...
int UIKit_CreateWindow(_THIS, SDL_Window *window) {
	...
	/*
	if (nil != [ShoutOutAppDelegate sharedAppDelegate].window) {
	...
	*/
	if (SetupWindowData(_this, window, [ShoutOutAppDelegate sharedAppDelegate].window, SDL_TRUE) < 0) {
        //[uiwindow release];
        return -1;
    }	
	...
	//[ShoutOutAppDelegate sharedAppDelegate].window = uiwindow;
	[ShoutOutAppDelegate sharedAppDelegate].windowID = window->id;
...
void UIKit_DestroyWindow(_THIS, SDL_Window * window) {
	...
	//[ShoutOutAppDelegate sharedAppDelegate].window = nil;
	[ShoutOutAppDelegate sharedAppDelegate].windowID = 0;

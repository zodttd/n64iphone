...
{
  if(![[NSFileManager defaultManager] fileExistsAtPath:@"/Applications/n64iphone.app/searched"])
  {
    FILE* fp = fopen("/Applications/n64iphone.app/searched", "w");
    if(fp)
    {
      fclose(fp);
    }
  	UIAlertView* alertView=[[UIAlertView alloc] initWithTitle:nil
                      message:@"This interface allows you to download .zip and N64 ROM files directly from the web into the correct directory for n64iphone. You may only download ROMS you legally own. n64iphone and ZodTTD are not affiliated/associated with any of these sites. Please do not contact us for support downloading roms. Simply browse a site, find a ROM you own, and press download - the file will download and will be available to play."
